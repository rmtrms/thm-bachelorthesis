...
\input{kapitel/kapitel_einleitung}
\input{kapitel/kapitel_grundlagen}
\input{kapitel/kapitel_stand-der-technik}
\input{kapitel/kapitel_anwendungsszenarien}
\input{kapitel/kapitel_anforderungen}
\input{kapitel/kapitel_daten}
\input{kapitel/kapitel_benchmark}
\input{kapitel/kapitel_prompt-engineering}
\input{kapitel/kapitel_fine-tuning}
\input{kapitel/kapitel_copyright-scanner}
\input{kapitel/kapitel_disukussion}
\input{kapitel/kapitel_fazit}
