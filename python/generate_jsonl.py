...
# Configuration
DATA_ROOT = Path("/Volumes/Data/fine-tuning-data")
DIRECTORIES = [
    "multiple_copyrights_with_authors",
    "format-insensitive matches",
    "single_copyrights_without_authors"
]
...
for subdir in DIRECTORIES:
    ...
    for txt_file in filtered_txts:
        ...
        json_file = f"{sha1}_scancode.json"
